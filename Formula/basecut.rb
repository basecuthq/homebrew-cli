...
class Basecut < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "fdf1d6ff5e031cfa1a1bdea0655585700b43a54180b348002c22d1446f60b16d"
    end
    on_arm do
      url "https://github.com/basecuthq/cli/releases/download/v#{version}/basecut-#{version}-darwin-arm64"
      sha256 "34c4d5fcddbe6e1dd1cc09e8f7133ec9969fa17e0a67b8beaacd924d4f1a140b"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "0a04e218cd969dfab2c94bbb209a43c8cda60c8aaffb271966236a5c43848b30"
    end
    on_arm do
      url "https://github.com/basecuthq/cli/releases/download/v#{version}/basecut-#{version}-linux-arm64"
      sha256 "e510192a7aba20bda88613280b5e66d0634e6493b7d2594ee088e90986aa2596"
    end
  end
